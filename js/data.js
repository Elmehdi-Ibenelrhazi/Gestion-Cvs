export const cvs =  [
    ...
    },
    {
        profile: {
            ...
            links: ["https://www.linkedin.com/in/marouane-elghayate-42b116172/", "https://github.com/marouaneelghayate/"]
        },
        education: [
            {
        ...
        technologySkills: [
            ...
            {
                skill: "Ingénierie DevOps",
                details: ["Maven", "Git", "GitHub", "GitLab", "Jira", "Jenkins", "JUnit", "Selenuim", "JMeter", "Gitlab CI", "Docker"]
            },
            {
                skill: "Technologie XML",
                details: ["Standard XML", "Bases de données XML", "Parseurs XML (DOM, SAX)", "DTD", "XSD (XML Schema)", "XSLT", "XPath", "XQuery"]
        ...
        softSkills: ["Communication", "Esprit d'équipe", "Intelligence Emotionnelle", "Empatie et Ecoute", "Créativité", "Capacité de Résolution de problèmes", "Adaptabilité", "Gestion du Temps", "Rigueur", "Organisation", "Gestion du Stress", "Présence"],
        languages: [
            {
                language: "Français",
        ...
        interests: ["jouer aux échecs", "faire du sport", "Programmation"]
    },
    {
        profile: {
            photo: "/images/laktam.png",
            firstName: "Abdellah",
            lastName: "Laktam",
            birthday: {
                day: 23,
    ...
    {
        profile: {
          photo: "/images/Amine_Hmidani_Filali.png",
          firstName: "Amine",
    ...
    },
    {
        ...
        profile: {
            photo: "/images/El Maalmi Ayoub.png",
            firstName: "Ayoub",
            lastName: "El Maalmi",
            birthday: {
                day: 6,
    ...
    {
        profile: {
            photo: "/images/photo El Mehdi Amarti Riffi.png",
            firstName: "El Mehdi ",
    ...
    {
        profile : {
            photo: "/images/Abdelhamid_Fadel.png",
    ...
    {
        profile: {
          photo: "/images/hamza_seddouki.jpeg",
          firstName: "Hamza",
          lastName: "SEDDOUKI",
          birthday: {
            day: 4,
      ...
      {
        profile: {
        photo: "/images/Manal_Zazouli.png",
        firstName: "Manal",
        lastName: "ZAZOULI",
        birthday: {
            day: 13,
    ...
    {
        profile : {
            photo: "/images/Masrour Ghita.png",
            firstName: "Ghita",
            lastName: "Masrour",
            birthday: {
                day: 10,
    ...
    {
        profile : {
            photo: "/images/Oubella FatimaEzzahrae.jpg",
    ...
    {
        profile : {
            photo: "/images/PHOTO-VALGUENA.jpg",
